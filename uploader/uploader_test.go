...
func TestUpload_Run(t *testing.T) {
	...
	for _, tc := range testCases {
		if tc.mockUploadBOM.enable {
			mockDTrack.EXPECT().UploadBOM(ctx, tc.mockUploadBOM.projectName, tc.mockUploadBOM.projectVersion, tc.mockUploadBOM.parentName, tc.mockUploadBOM.parentVersion, gomock.Any(), gomock.Any()).Return(tc.mockUploadBOM.err)
		}
